...
class KategoriHotelPurwokertoActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        // 1. Menghubungkan ke layout XML
        setContentView(R.layout.activity_kategori_hotel_purwokerto)
        ...
        btnLuxury.setOnClickListener {
            val intent = Intent(this, PembayaranActivity::class.java)
            intent.putExtra("JENIS_KAMAR", "Smart Budget Room")
            intent.putExtra("HARGA", 385000) // Silakan sesuaikan harganya dengan desain Anda
            startActivity(intent)
        }
    }
}